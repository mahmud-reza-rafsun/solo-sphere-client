      ...
      (t) => (
        <div className='text-center space-y-3'>
          ...
          <div className='gap-3 flex'>
            <button className='bg-red-400 text-white btn-sm rounded-md font-semibold' onClick={() => {
              toast.dismiss(t.id)
              handleDelete(id)}
            }>Delete</button>
            <button className='bg-blue-400 text-white btn-sm rounded-md font-semibold' onClick={() => toast.dismiss(t.id)}>Close</button>
          </div>
        </div>
      )
    );
                    ...
                    jobs && jobs.length > 0 ? jobs.map((job) => <tr key={job?._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-6'>
                          <button onClick={() => mordernDelete(job._id)} className='text-gray-500 transition-colors duration-200 hover:text-red-500 focus:outline-none'>
                            <svg
